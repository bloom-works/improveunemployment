...
Considering how the metric will be monitored and reported is a key consideration in crafting the metric in the first place. 
...
[^137]:
     [https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf](https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf) p ix
...
[^139]:
     https://www.nelp.org/publication/nelp-testimony-michele-evermore-michigan-unemployment-claims-processing/
...
[^145]:
     https://www.governing.com/now/government-programs-should-measure-how-well-they-help-people.html
...
[^152]:
     ...
     While membership in a consortium allows WIC State agencies to share resources and funding, some State agencies have found that this model can make it difficult to get new features prioritized, and that the pace of development and releases can seriously delay critical improvements to the participant experience. Additionally, members of the consortia we spoke to explained that regardless of caseload or funds contributed, all members have equal voting power, which can be frustrating when needs are different due to a different scale of operations.  - [link](https://s3.amazonaws.com/aws.upl/nwica.org/wic-technology-landscape-_-final-report-design.pdf)
...
[^154]:
     ...
     “Iowa left the consortium early on due to concerns over Iowa’s ability to support the underlying .net technology (vs. the Java platform they were using).” [link](https://vermontdailychronicle.com/2020/04/22/scott-pulled-plug-on-troubled-ui-upgrade-then-this-pandemic-hit/)

[^155]:

     “Agency of Digital Services Secretary John Quinn’s provided more detail: “The underlying issue is that Idaho is not willing to give up intellectual property rights of the system being developed, and they will not hesitate to act in the best interest of their state regardless of the effect on the consortium or partner states,” he explained to Vermont Daily earlier this week” [link](https://vermontdailychronicle.com/2020/04/22/scott-pulled-plug-on-troubled-ui-upgrade-then-this-pandemic-hit/)

[^156]:

     “VT and ND have been beholden to partner state Idaho as both VT and ND do not have the internal development staff to build their own systems. Idaho has been willing to collaborate with VT and ND who pay for Idaho resources involved with system development. Yet, as ID is a sovereign state, VT and ND have little to no recourse to hold ID accountable for the quality or content that is developed nor the timeline in which it is delivered.” [link](https://vermontdailychronicle.com/2020/04/22/scott-pulled-plug-on-troubled-ui-upgrade-then-this-pandemic-hit/)
...
[^160]:
     ...
     “It’s important that co-ops start small; not 20 members, but 2.” - [link](https://beeckcenter.georgetown.edu/wp-content/uploads/2021/04/Sharing-Government-Software_Final.pdf)
