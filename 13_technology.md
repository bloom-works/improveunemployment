...
## Modernization
We recommend that everyone stop using the word “modernization” in the context of unemployment systems, immediately. Instead, focus on [claimant-centric outcomes](#bookmark=id.9thpdd5s62m) and [related North Star goals](#bookmark=id.ri0gvh9dgcgd).
...
We recommend that every state instrument their unemployment websites and include review of the data in regular integrated [command meetings](#bookmark=id.j9deu76xsjtw). Tools like Google Analytics have policies in place to protect visitors’ privacy while gathering the data you need. 
...
*   Redesign it, with user experience and Key Performance Indicators (KPIs) ([goals](#bookmark=id.9thpdd5s62m)) in mind. 
...
[^123]:
     [https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf](https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf) p222

[^124]:
     https://www.nelp.org/publication/nelp-testimony-michele-evermore-michigan-unemployment-claims-processing/

[^125]:
     [https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf](https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf) p178

[^126]:
     [https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf](https://www.naswa.org/system/files/2021-03/usdolreleasesnaswareport.pdf) p179
